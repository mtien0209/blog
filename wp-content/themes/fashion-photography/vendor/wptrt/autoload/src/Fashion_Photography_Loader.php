...
class Fashion_Photography_Loader {
	/**
	 * Array of loaders.
	 *
	 * @since  1.0.0
	 ...
	 * @return void
	 */
	public function fashion_photography_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function fashion_photography_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function fashion_photography_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function fashion_photography_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->fashion_photography_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function fashion_photography_load( $class ) {
